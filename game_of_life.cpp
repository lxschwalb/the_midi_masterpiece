...
void GameOfLife::begin(Adafruit_NeoTrellisM4 *x, bool *interupt_flag){
  trellis = x;
  _interupt_flag = interupt_flag;
  bins[0].begin(x, 0xFFFFFF, bin_locations[0], 4);
  bins[1].begin(x, 0xFFFFFF, bin_locations[1], 4);
  bins[2].begin(x, 0xFFFFFF, bin_locations[2], 4);
  bins[3].begin(x, 0xFFFFFF, bin_locations[3], 4);
  bins[4].begin(x, 0xFFFFFF, bin_locations[4], 4);
  bins[5].begin(x, 0xFFFFFF, bin_locations[5], 4);
  bins[6].begin(x, 0xFFFFFF, bin_locations[6], 4);
  bins[7].begin(x, 0xFFFFFF, bin_locations[7], 4);
